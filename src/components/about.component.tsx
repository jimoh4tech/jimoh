...
const experinceList: ExperienceProps[] = [
  ...
  {
    label: "Work Experience",
    duration: "August 2024 - Present (Contract)",
    title: "Fullstack  Engineer | Pedestal Africa | Lagos, Nigeria | Remote",
    descriptions: [
      "Implementation of Know Your Customer (KYC) features, enhancing security compliance and user verification processes.",
      "Optimized the existing codebase and fixed critical bugs, improving system performance and reducing load times.",
      "Integrated a payment gateway supporting multiple subscription plans, handling complex billing requirements.",
      "Developed secure document upload and download features using cloudinary, providing scalable storage solutions.",
      "Streamlined deployment workflows by automating CI/CD pipelines, reducing deployment time and minimizing errors.",
      "Employed microservice architecture for scalable, independent service deployments on AWS infrastructure, improving system modularity and maintainability.",
    ],
  },
  {
...
const Skills = () => {
  ...
  const set2 =
    " React JS, Next JS, Node JS, Express JS, Fastify, Nest JS, MongoDB, PostgreSQL, Elastic Search, MySQL, SQLite, REST API, GraphQL";
        ...
        <Stack gap={16}>
          ...
          >
            ...
            <Text fontSize={isLessThan1100 ? "sm" : "md"} textAlign={"justify"}>
              Backend Engineer with 4+ years of working experience in designing
